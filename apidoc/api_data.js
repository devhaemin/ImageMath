define({ "api": [
  ...
  {
    "type": "get",
    "url": "video/:videoSeq/:lectureSeq/user",
    "title": "수업별 학생 전체 비디오 권한 목록",
    "name": "getPermissionUserListWithLecture",
    "group": "Video",
    "header": {
      "fields": {
        "Header": [
